...
使用方法:
    python scripts/generate_figures.py                              # 使用默认配置
...
def generate_all_figures(results_dir=None, figures_dir=None):
    ...
    print("\n[1/5] 绘制训练曲线...")
    try:
        from scripts.visualize.visualize_training import plot_training_curves
    ...
    try:
        ...
        model_names = ['model_supcon', 'model_baseline']
        ...
        for model_name in model_names:
            ...
            if os.path.exists(model_path):
                ...
                model = ContrastiveHateSpeechModel(model_config).to(device)
